...
def parse_detail_page(html: str, url: str) -> Listing:
    ...
    # Extract description = full page text (already scraped as text_all)
    # This reliably includes the "Ficha técnica" section with movement type,
    # diameter, brand etc. The specific div selectors don't work reliably on CC.
    description = text_all[:1200]  # first 1200 chars contain ficha técnica
