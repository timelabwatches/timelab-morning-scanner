...
GLOBAL_ACCESSORY_TERMS = {
    ...
    "instruction", "instructions", "instruction manual", "manuale", "booklet", "libretto",
...
WATCH_INDICATORS = {
    ...
    "automatic", "automatik", "automatique", "automatico", "automático",
    "chronograph", "chrono", "gmt",
    "date", "diver", "sub",
    "seamaster", "speedmaster", "aquaracer", "hydroconquest", "constellation",
    "manual wind", "hand wound", "self-winding", "hand-wound",
...
INCOMPLETE_HARD_TERMS = {
    ...
    "vintage box",
    # Books/publications about watches
    "libro", "copertina", "buch", "book about", "livro", "monograph",
    # Italian parts terms (lunetta=bezel, fondello=caseback, quadrante=dial)
    "lunetta", "lunette", "fondello", "ghiera",
    # Seiko VK63 microbrands
    "mysterious code", "san martin", "baltany", "furlan marri",
}
...
PARTS_ONLY_PATTERNS = [
    ...
    r"\bglass for\b",
    r"\bverre pour\b",
    r"^box [a-z]+",          # "Box omega...", "Box rolex..." = selling the box
    r"\blunetta\b",        # Italian: bezel
    r"\blunette\b",        # French: bezel  
    r"\bghiera\b",         # Italian: bezel/ring
    r"\bfondello\b",       # Italian: caseback
    r"^libro\b",            # Italian/Spanish: book
]
