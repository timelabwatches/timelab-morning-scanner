...
def run() -> None:
    ...
    for listing in all_listings:
        ...
        # WP: use "medium" as default match_band, not "low" (avoids blanket SKIP from model_master gaps)
        wp_match_band = identity.get("match_confidence_band") or "medium"
        wp_ambiguity  = bool(identity.get("model_ambiguity", False))
        gate = gate_decision(
            wp_match_band, sample_size, valuation_conf,
