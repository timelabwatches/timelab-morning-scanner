...
# Calibrated with:
#   - TIMELAB Q1 2026 real Catawiki sales (77 units)
#   - Chrono24 Apr 2026 secondary market data (hammer ≈ Chrono24-used × 0.65)
#   - Known Catawiki auction patterns by model family
# Format: (p25, p50, p75) — Catawiki hammer EUR, NO-reserve auctions
# Last updated: 2026-04-15 v14
BRAND_FAMILY_FALLBACKS = {
    # ── OMEGA ────────────────────────────────────────────────────────────────
    "omega": {
        "geneve":               (280.0,  420.0,  580.0),
        "de ville":             (280.0,  400.0,  560.0),
        "constellation":        (260.0,  400.0,  580.0),
        "constellation modern": (180.0,  280.0,  400.0),
        "seamaster":            (480.0,  680.0,  920.0),
        "aqua terra":           (1200.0, 1600.0, 2000.0),
        "speedmaster":          (1600.0, 2200.0, 3200.0),
        "railmaster":           (450.0,  650.0,  900.0),
        "chronograph":          (700.0,  1100.0, 1600.0),
        "brand_fallback":       (280.0,  450.0,  680.0),
    },
    # ── LONGINES ─────────────────────────────────────────────────────────────
    # Q1 real: Flagship €890, 22AS €505
    "longines": {
        "flagship":             (380.0,  580.0,  820.0),
        "conquest":             (280.0,  400.0,  580.0),
        "hydroconquest":        (580.0,  780.0,  1020.0),
        "master collection":    (600.0,  820.0,  1050.0),
        "admiral":              (260.0,  400.0,  580.0),
        "presence":             (100.0,  180.0,  280.0),
        "lindbergh":            (600.0,  900.0,  1400.0),
        "spirit":               (700.0,  950.0,  1200.0),
        "chronograph":          (380.0,  580.0,  820.0),
        "brand_fallback":       (200.0,  340.0,  520.0),
    },
    # ── TISSOT ───────────────────────────────────────────────────────────────
    # Q1 real: 24 sales avg €209. PRX PM80 €580, Seastar PM80 €700.
    # Chrono24 PRX PM80 used: ~€500-600 → Catawiki hammer €420-520
    "tissot": {
        "prx":                  (380.0,  480.0,  580.0),
        "prx quartz":           (80.0,   140.0,  220.0),
        "seastar":              (460.0,  580.0,  720.0),
        "le locle":             (180.0,  280.0,  380.0),
        "visodate":             (160.0,  240.0,  340.0),
        "t-race":               (120.0,  200.0,  300.0),
        "gentleman":            (250.0,  350.0,  460.0),
        "couturier":            (140.0,  220.0,  320.0),
        "t-touch":              (120.0,  200.0,  300.0),
        "pr 100":               (60.0,   120.0,  200.0),
        "pr 50":                (50.0,   90.0,   150.0),
        "chronograph":          (120.0,  200.0,  280.0),
        "brand_fallback":       (80.0,   160.0,  260.0),
    },
    # ── SEIKO ────────────────────────────────────────────────────────────────
    # KEY FIX: Presage SRPC79 Catawiki ~€150-220, NOT €560
    # SARX/enamel dials: €400-700. Generic Presage: €140-320.
    "seiko": {
        "prospex":              (220.0,  340.0,  480.0),
        "prospex turtle":       (280.0,  380.0,  500.0),
        "prospex diver":        (220.0,  320.0,  440.0),
        "presage":              (140.0,  210.0,  320.0),
        "presage cocktail":     (280.0,  420.0,  600.0),
        "5 sports":             (80.0,   130.0,  200.0),
        "chronograph":          (140.0,  220.0,  340.0),
        "vintage dress":        (100.0,  160.0,  240.0),
        "kinetic diver":        (80.0,   130.0,  190.0),
        "brand_fallback":       (80.0,   150.0,  240.0),
    },
    # ── HAMILTON ─────────────────────────────────────────────────────────────
    # Q1 real: Khaki Field €460, Regatta vtg €760
    # Chrono24: Khaki Field Auto used ~€480, Ventura auto ~€500
    "hamilton": {
        "khaki field":          (300.0,  420.0,  560.0),
        "khaki field murph":    (620.0,  820.0,  1020.0),
        "khaki navy":           (380.0,  520.0,  700.0),
        "khaki aviation":       (350.0,  520.0,  720.0),
        "khaki regatta":        (380.0,  560.0,  780.0),
        "jazzmaster":           (380.0,  520.0,  700.0),
        "ventura":              (320.0,  440.0,  620.0),
        "american classic":     (200.0,  320.0,  460.0),
        "chronograph":          (380.0,  560.0,  760.0),
        "brand_fallback":       (200.0,  340.0,  500.0),
    },
    # ── TAG HEUER ────────────────────────────────────────────────────────────
    "tagheuer": {
        "formula 1":            (520.0,  700.0,  900.0),
        "aquaracer":            (580.0,  800.0,  1050.0),
        "link":                 (520.0,  750.0,  1000.0),
        "carrera":              (1200.0, 1700.0, 2400.0),
        "monaco":               (2800.0, 3800.0, 5000.0),
        "2000 professional":    (120.0,  200.0,  300.0),
        "kirium":               (200.0,  320.0,  460.0),
        "chronograph":          (700.0,  1100.0, 1700.0),
        "brand_fallback":       (450.0,  720.0,  1050.0),
    },
    # ── ORIS ─────────────────────────────────────────────────────────────────
    # Chrono24 BCPD new ~€1,000-1,300. Catawiki hammer ~€580-820.
    # Q1 real: 1 sale €261 (generic vintage)
    "oris": {
        "big crown":            (480.0,  660.0,  880.0),
        "bcpd":                 (480.0,  660.0,  880.0),
        "aquis":                (500.0,  680.0,  900.0),
        "divers sixty":         (580.0,  780.0,  1000.0),
        "divers":               (400.0,  580.0,  780.0),
        "propilot":             (400.0,  580.0,  800.0),
        "vintage":              (140.0,  220.0,  340.0),
        "chronograph":          (380.0,  560.0,  780.0),
        "brand_fallback":       (200.0,  320.0,  480.0),
    },
    # ── BREITLING ────────────────────────────────────────────────────────────
    "breitling": {
        "navitimer":            (700.0,  1100.0, 1700.0),
        "navitimer modern":     (1400.0, 1900.0, 2600.0),
        "colt":                 (620.0,  880.0,  1200.0),
        "superocean":           (700.0,  1000.0, 1400.0),
        "avenger":              (700.0,  1050.0, 1500.0),
        "aerospace":            (250.0,  380.0,  520.0),
        "chronograph":          (800.0,  1300.0, 2000.0),
        "brand_fallback":       (580.0,  900.0,  1400.0),
    },
    # ── TUDOR ────────────────────────────────────────────────────────────────
    "tudor": {
        "black bay":            (1400.0, 1900.0, 2600.0),
        "black bay 58":         (1600.0, 2100.0, 2800.0),
        "pelagos":              (1600.0, 2200.0, 3000.0),
        "ranger":               (700.0,  1000.0, 1400.0),
        "prince":               (350.0,  520.0,  720.0),
        "submariner":           (1400.0, 2000.0, 3000.0),
        "chronograph":          (900.0,  1400.0, 2000.0),
        "brand_fallback":       (700.0,  1100.0, 1700.0),
    },
    # ── IWC ──────────────────────────────────────────────────────────────────
    "iwc": {
        "pilot":                (550.0,  820.0,  1150.0),
        "flieger":              (550.0,  820.0,  1150.0),
        "ingenieur":            (700.0,  1050.0, 1500.0),
        "aquatimer":            (600.0,  900.0,  1250.0),
        "schaffhausen":         (300.0,  480.0,  700.0),
        "chronograph":          (800.0,  1250.0, 1900.0),
        "brand_fallback":       (500.0,  800.0,  1200.0),
    },
    # ── ZENITH ───────────────────────────────────────────────────────────────
    # Q1 real: avg €270 (generic vintage). El Primero premium.
    "zenith": {
        "el primero":           (700.0,  1100.0, 1700.0),
        "pilot":                (600.0,  900.0,  1300.0),
        "port royal":           (200.0,  320.0,  480.0),
        "elite":                (280.0,  420.0,  600.0),
        "chronograph":          (400.0,  680.0,  1050.0),
        "brand_fallback":       (180.0,  280.0,  420.0),
    },
    # ── JUNGHANS ─────────────────────────────────────────────────────────────
    # Q1 real: Max Bill €510
    "junghans": {
        "max bill":             (320.0,  500.0,  700.0),
        "meister":              (240.0,  380.0,  540.0),
        "chronograph":          (220.0,  360.0,  540.0),
        "brand_fallback":       (180.0,  300.0,  460.0),
    },
    # ── CERTINA ──────────────────────────────────────────────────────────────
    # Q1 real: DS First €266, Vintage €113
    "certina": {
        "ds action":            (300.0,  440.0,  620.0),
        "ds podium":            (160.0,  260.0,  380.0),
        "ds-1":                 (180.0,  280.0,  400.0),
        "ds-2":                 (160.0,  250.0,  360.0),
        "ds":                   (140.0,  220.0,  340.0),
        "chronograph":          (180.0,  280.0,  400.0),
        "brand_fallback":       (120.0,  200.0,  320.0),
    },
    # ── BAUME ET MERCIER ─────────────────────────────────────────────────────
    # Q1 real: Classima avg €512 (2 real sales: €400/€625)
    "baume": {
        "classima":             (360.0,  520.0,  720.0),
        "riviera":              (1000.0, 1400.0, 1900.0),
        "clifton":              (1200.0, 1700.0, 2300.0),
        "hampton":              (400.0,  600.0,  820.0),
        "chronograph":          (800.0,  1200.0, 1700.0),
        "brand_fallback":       (340.0,  540.0,  780.0),
    },
    # ── BULOVA ───────────────────────────────────────────────────────────────
    "bulova": {
        "marine star":          (140.0,  210.0,  300.0),
        "lunar pilot":          (280.0,  380.0,  500.0),
        "precisionist":         (200.0,  300.0,  400.0),
        "accutron":             (120.0,  200.0,  300.0),
        "chronograph":          (140.0,  230.0,  340.0),
        "brand_fallback":       (100.0,  180.0,  280.0),
    },
    # ── CITIZEN ──────────────────────────────────────────────────────────────
    "citizen": {
        "promaster":            (180.0,  280.0,  380.0),
        "eco-drive":            (80.0,   140.0,  220.0),
        "tsuyosa":              (200.0,  290.0,  390.0),
        "diver":                (180.0,  270.0,  370.0),
        "chronograph":          (100.0,  170.0,  260.0),
        "brand_fallback":       (80.0,   160.0,  260.0),
    },
    # ── CYMA ─────────────────────────────────────────────────────────────────
    # Q1 real: best ROI brand
    "cyma": {
        "vintage automatic":    (160.0,  260.0,  380.0),
        "brand_fallback":       (120.0,  220.0,  340.0),
    },
    # ── FORTIS ───────────────────────────────────────────────────────────────
    # Q1 real: Cosmonauts strong
    "fortis": {
        "cosmonauts":           (500.0,  700.0,  950.0),
        "spaceman":             (400.0,  580.0,  800.0),
        "flieger":              (320.0,  480.0,  680.0),
        "b-42":                 (350.0,  520.0,  720.0),
        "brand_fallback":       (280.0,  440.0,  640.0),
    },
    # ── CAUNY ────────────────────────────────────────────────────────────────
    # Q1 real: top ROI brand (vintage Swiss)
    "cauny": {
        "prima":                (100.0,  180.0,  280.0),
        "brand_fallback":       (80.0,   150.0,  240.0),
    },
    # ── ORIENT ───────────────────────────────────────────────────────────────
    "orient": {
        "bambino":              (120.0,  190.0,  270.0),
        "kamasu":               (140.0,  210.0,  300.0),
        "mako":                 (120.0,  190.0,  270.0),
        "ray":                  (120.0,  190.0,  270.0),
        "star":                 (200.0,  320.0,  460.0),
        "king diver":           (200.0,  320.0,  460.0),
        "brand_fallback":       (80.0,   160.0,  260.0),
    },
}
